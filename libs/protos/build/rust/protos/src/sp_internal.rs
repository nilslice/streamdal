...
pub struct NotifyRequest {
    ...
    // @@protoc_insertion_point(field:protos.NotifyRequest.step_condition)
    pub step_condition: ::protobuf::MessageField<super::sp_pipeline::PipelineStepConditions>,
...
impl NotifyRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::sp_pipeline::PipelineStepConditions>(
            "step_condition",
            |m: &NotifyRequest| { &m.step_condition },
            |m: &mut NotifyRequest| { &mut m.step_condition },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "payload",
...
impl ::protobuf::Message for NotifyRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                50 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.step_condition)?;
                },
                58 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.step_condition.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
    ...
    fn default_instance() -> &'static NotifyRequest {
        static instance: NotifyRequest = NotifyRequest {
            ...
            step_condition: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x13occurredAtUnixTsUtc\x12(\n\x04step\x18\x05\x20\x01(\x0b2\x14.protos.\
    PipelineStepR\x04step\x12E\n\x0estep_condition\x18\x06\x20\x01(\x0b2\x1e\
    .protos.PipelineStepConditionsR\rstepCondition\x12\x18\n\x07payload\x18\
    \x07\x20\x01(\x0cR\x07payload\":\n\x0eMetricsRequest\x12(\n\x07metrics\
    ...
    \x04\x04\x02\x02\0\x12\x03H\x02\x19\x1a,\x20PipelineID\x20that\x20trigge\
    red\x20the\x20notification\n\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03H\x02\
    \x08\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03H\t\x14\n\x0c\n\x05\x04\x02\
    \x02\0\x03\x12\x03H\x17\x18\n%\n\x04\x04\x02\x02\x01\x12\x03K\x02)\x1a\
    \x18\x20Use\x20step\x20field\x20instead\n\n\x0c\n\x05\x04\x02\x02\x01\
    \x05\x12\x03K\x02\x08\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03K\t\x12\n\
    \x0c\n\x05\x04\x02\x02\x01\x03\x12\x03K\x15\x16\n\x0c\n\x05\x04\x02\x02\
    \x01\x08\x12\x03K\x17(\n\r\n\x06\x04\x02\x02\x01\x08\x03\x12\x03K\x18'\n\
    p\n\x04\x04\x02\x02\x02\x12\x03O\x02\x18\x1ac\x20Audience\x20that\x20tri\
    ggered\x20the\x20notification\x20since\x20a\x20pipeline\n\x20can\x20be\
    \x20attached\x20to\x20multiple\x20audiences.\n\n\x0c\n\x05\x04\x02\x02\
    \x02\x06\x12\x03O\x02\n\n\x0c\n\x05\x04\x02\x02\x02\x01\x12\x03O\x0b\x13\
    \n\x0c\n\x05\x04\x02\x02\x02\x03\x12\x03O\x16\x17\nG\n\x04\x04\x02\x02\
    \x03\x12\x03R\x02$\x1a:\x20The\x20exact\x20time\x20the\x20notification\
    \x20was\x20triggered\x20by\x20the\x20SDK\n\n\x0c\n\x05\x04\x02\x02\x03\
    \x05\x12\x03R\x02\x07\n\x0c\n\x05\x04\x02\x02\x03\x01\x12\x03R\x08\x1f\n\
    \x0c\n\x05\x04\x02\x02\x03\x03\x12\x03R\"#\n<\n\x04\x04\x02\x02\x04\x12\
    \x03U\x02\x18\x1a/\x20Pipeline\x20step\x20that\x20triggered\x20the\x20no\
    tification\n\n\x0c\n\x05\x04\x02\x02\x04\x06\x12\x03U\x02\x0e\n\x0c\n\
    \x05\x04\x02\x02\x04\x01\x12\x03U\x0f\x13\n\x0c\n\x05\x04\x02\x02\x04\
    \x03\x12\x03U\x16\x17\n\x98\x01\n\x04\x04\x02\x02\x05\x12\x03Y\x02,\x1a\
    \x8a\x01\x20The\x20condition\x20config\x20for\x20this\x20notification.\n\
    \x20This\x20message\x20contains\x20metadata\x20which\x20might\x20be\x20u\
    seful\x20and\x20also\x20the\x20payload\x20inclusion\x20config.\n\n\x0c\n\
    \x05\x04\x02\x02\x05\x06\x12\x03Y\x02\x18\n\x0c\n\x05\x04\x02\x02\x05\
    \x01\x12\x03Y\x19'\n\x0c\n\x05\x04\x02\x02\x05\x03\x12\x03Y*+\n\x8d\x02\
    \n\x04\x04\x02\x02\x06\x12\x03_\x02\x14\x1a\xff\x01\x20Contains\x20the\
    \x20entire\x20payload\x20that\x20triggered\x20the\x20notification\n\x20T\
    his\x20data\x20or\x20a\x20selection\x20of\x20paths\x20from\x20it\x20can\
    \x20be\x20included\x20inside\x20the\x20notification\x20request\n\x20We\
    \x20ship\x20the\x20entire\x20payload\x20to\x20the\x20server\x20because\
    \x20of\x20the\x20complexity\x20of\x20extracting\x20paths\n\x20via\x20eac\
    h\x20SDK.\n\n\x0c\n\x05\x04\x02\x02\x06\x05\x12\x03_\x02\x07\n\x0c\n\x05\
    \x04\x02\x02\x06\x01\x12\x03_\x08\x0f\n\x0c\n\x05\x04\x02\x02\x06\x03\
    ...
    \x12\x03h\x18\x19\n\xad\x01\n\x04\x04\x04\x02\x01\x12\x03n\x02\x18\x1a\
    ...
    \x04\x04\x02\x01\x03\x12\x03n\x16\x17\nQ\n\x04\x04\x04\x02\x02\x12\x03q\
    \x02$\x1aD\x20REQUIRED\x20--\x20Info\x20about\x20the\x20client\x20(lib\
    \x20name,\x20lang,\x20os,\x20arch,\x20etc.)\n\n\x0c\n\x05\x04\x04\x02\
    \x02\x06\x12\x03q\x02\x13\n\x0c\n\x05\x04\x04\x02\x02\x01\x12\x03q\x14\
    \x1f\n\x0c\n\x05\x04\x04\x02\x02\x03\x12\x03q\"#\n\x87\x01\n\x04\x04\x04\
    \x02\x03\x12\x03u\x02)\x1az\x20OPTIONAL\x20--\x20if\x20these\x20are\x20d\
    ...
    \x04\x04\x02\x03\x06\x12\x03u\x0b\x1a\n\x0c\n\x05\x04\x04\x02\x03\x01\
    \x12\x03u\x1b$\n\x0c\n\x05\x04\x04\x02\x03\x03\x12\x03u'(\n\xd9\x01\n\
    \x04\x04\x04\x02\x04\x12\x03z\x02\x13\x1a\xcb\x01\x20OPTIONAL\x20--\x20I\
    ...
    \x04\x04\x02\x04\x01\x12\x03z\x07\x0e\n\x0c\n\x05\x04\x04\x02\x04\x03\
    \x12\x03z\x11\x12\nU\n\x02\x04\x05\x12\x05~\0\x81\x01\x01\x1aH\x20Same\
    ...
    \x04\x04\x05\x02\0\x12\x03\x7f\x02\x1a\n\x0c\n\x05\x04\x05\x02\0\x05\x12\
    \x03\x7f\x02\x08\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x03\x7f\t\x15\n\x0c\n\
    \x05\x04\x05\x02\0\x03\x12\x03\x7f\x18\x19\n\x0c\n\x04\x04\x05\x02\x01\
    \x12\x04\x80\x01\x02\x18\n\r\n\x05\x04\x05\x02\x01\x05\x12\x04\x80\x01\
    \x02\x08\n\r\n\x05\x04\x05\x02\x01\x01\x12\x04\x80\x01\t\x13\n\r\n\x05\
    \x04\x05\x02\x01\x03\x12\x04\x80\x01\x16\x17\n\x0c\n\x02\x04\x06\x12\x06\
    \x83\x01\0\x85\x01\x01\n\x0b\n\x03\x04\x06\x01\x12\x04\x83\x01\x08)\n\
    \x0c\n\x04\x04\x06\x02\0\x12\x04\x84\x01\x02\x1a\n\r\n\x05\x04\x06\x02\0\
    \x05\x12\x04\x84\x01\x02\x08\n\r\n\x05\x04\x06\x02\0\x01\x12\x04\x84\x01\
    \t\x15\n\r\n\x05\x04\x06\x02\0\x03\x12\x04\x84\x01\x18\x19\n\x0c\n\x02\
    \x04\x07\x12\x06\x87\x01\0\x91\x01\x01\n\x0b\n\x03\x04\x07\x01\x12\x04\
    \x87\x01\x08*\n7\n\x04\x04\x07\x02\0\x12\x04\x89\x01\x02%\x1a)\x20Attach\
    Commands\x20for\x20all\x20active\x20pipelines\n\n\r\n\x05\x04\x07\x02\0\
    \x04\x12\x04\x89\x01\x02\n\n\r\n\x05\x04\x07\x02\0\x06\x12\x04\x89\x01\
    \x0b\x19\n\r\n\x05\x04\x07\x02\0\x01\x12\x04\x89\x01\x1a\x20\n\r\n\x05\
    \x04\x07\x02\0\x03\x12\x04\x89\x01#$\nr\n\x04\x04\x07\x02\x01\x12\x04\
    \x8d\x01\x02%\x1ad\x20AttachCommands,\x20but\x20ones\x20which\x20are\x20\
    paused\n\x20The\x20SDK\x20still\x20needs\x20to\x20have\x20these\x20to\
    \x20support\x20un-pausing\n\n\r\n\x05\x04\x07\x02\x01\x04\x12\x04\x8d\
    \x01\x02\n\n\r\n\x05\x04\x07\x02\x01\x06\x12\x04\x8d\x01\x0b\x19\n\r\n\
    \x05\x04\x07\x02\x01\x01\x12\x04\x8d\x01\x1a\x20\n\r\n\x05\x04\x07\x02\
    \x01\x03\x12\x04\x8d\x01#$\n\x1c\n\x04\x04\x07\x02\x02\x12\x04\x90\x01\
    \x02*\x1a\x0e\x20ID\x20=\x20wasm\x20ID\n\n\r\n\x05\x04\x07\x02\x02\x06\
    \x12\x04\x90\x01\x02\x18\n\r\n\x05\x04\x07\x02\x02\x01\x12\x04\x90\x01\
    \x19%\n\r\n\x05\x04\x07\x02\x02\x03\x12\x04\x90\x01()\n\xc8\x01\n\x02\
    \x04\x08\x12\x06\x96\x01\0\x9f\x01\x01\x1a\xb9\x01\x20WasmModule\x20is\
    \x20used\x20to\x20ensure\x20we\x20only\x20send\x20the\x20wasm\x20module\
    \x20once\x20per\x20request\n\x20instead\x20of\x20duplicated\x20in\x20eve\
    ry\x20pipeline\x20where\x20it\x20is\x20used.\x20This\x20prevents\n\x20ov\
    er-sized\x20payloads\x20on\x20SDK\x20startup\n\n\x0b\n\x03\x04\x08\x01\
    \x12\x04\x96\x01\x08\x12\nQ\n\x04\x04\x08\x02\0\x12\x04\x98\x01\x02\x10\
    ...
    \x01\x02\x08\n\r\n\x05\x04\x08\x02\0\x01\x12\x04\x98\x01\t\x0b\n\r\n\x05\
    \x04\x08\x02\0\x03\x12\x04\x98\x01\x0e\x0f\n1\n\x04\x04\x08\x02\x01\x12\
    \x04\x9b\x01\x02\x12\x1a#\x20WASM\x20module\x20bytes\x20(set\x20by\x20se\
    rver)\n\n\r\n\x05\x04\x08\x02\x01\x05\x12\x04\x9b\x01\x02\x07\n\r\n\x05\
    \x04\x08\x02\x01\x01\x12\x04\x9b\x01\x08\r\n\r\n\x05\x04\x08\x02\x01\x03\
    \x12\x04\x9b\x01\x10\x11\n=\n\x04\x04\x08\x02\x02\x12\x04\x9e\x01\x02\
    \x16\x1a/\x20WASM\x20function\x20name\x20to\x20execute\x20(set\x20by\x20\
    server)\n\n\r\n\x05\x04\x08\x02\x02\x05\x12\x04\x9e\x01\x02\x08\n\r\n\
    \x05\x04\x08\x02\x02\x01\x12\x04\x9e\x01\t\x11\n\r\n\x05\x04\x08\x02\x02\
    \x03\x12\x04\x9e\x01\x14\x15\n\x0c\n\x02\x04\t\x12\x06\xa1\x01\0\xa4\x01\
    \x01\n\x0b\n\x03\x04\t\x01\x12\x04\xa1\x01\x08\x19\n\x0c\n\x04\x04\t\x02\
    \0\x12\x04\xa2\x01\x02\x18\n\r\n\x05\x04\t\x02\0\x06\x12\x04\xa2\x01\x02\
    \n\n\r\n\x05\x04\t\x02\0\x01\x12\x04\xa2\x01\x0b\x13\n\r\n\x05\x04\t\x02\
    \0\x03\x12\x04\xa2\x01\x16\x17\n\x0c\n\x04\x04\t\x02\x01\x12\x04\xa3\x01\
    \x02\x14\n\r\n\x05\x04\t\x02\x01\x06\x12\x04\xa3\x01\x02\x08\n\r\n\x05\
    \x04\t\x02\x01\x01\x12\x04\xa3\x01\t\x0f\n\r\n\x05\x04\t\x02\x01\x03\x12\
    \x04\xa3\x01\x12\x13b\x06proto3\
";
