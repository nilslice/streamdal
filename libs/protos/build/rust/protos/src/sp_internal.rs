...
pub struct NotifyRequest {
    ...
    // @@protoc_insertion_point(field:protos.NotifyRequest.step_id)
...
impl NotifyRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "step_id",
            |m: &NotifyRequest| { &m.step_id },
            |m: &mut NotifyRequest| { &mut m.step_id },
        ));
...
impl ::protobuf::Message for NotifyRequest {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.step_id.is_empty() {
            my_size += ::protobuf::rt::string_size(5, &self.step_id);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.step_id.is_empty() {
            os.write_string(5, &self.step_id)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \tstep_name\x18\x02\x20\x01(\tR\x08stepNameB\x02\x18\x01\x12,\n\x08audie\
    nce\x18\x03\x20\x01(\x0b2\x10.protos.AudienceR\x08audience\x124\n\x17occ\
    urred_at_unix_ts_utc\x18\x04\x20\x01(\x03R\x13occurredAtUnixTsUtc\x12\
    \x17\n\x07step_id\x18\x05\x20\x01(\tR\x06stepId\":\n\x0eMetricsRequest\
    \x12(\n\x07metrics\x18\x01\x20\x03(\x0b2\x0e.protos.MetricR\x07metrics\"\
    \xd1\x01\n\x0fRegisterRequest\x12!\n\x0cservice_name\x18\x01\x20\x01(\tR\
    \x0bserviceName\x12\x1d\n\nsession_id\x18\x02\x20\x01(\tR\tsessionId\x12\
    3\n\x0bclient_info\x18\x03\x20\x01(\x0b2\x12.protos.ClientInfoR\nclientI\
    nfo\x12.\n\taudiences\x18\x04\x20\x03(\x0b2\x10.protos.AudienceR\taudien\
    ...
    ByServiceRequest\x12!\n\x0cservice_name\x18\x01\x20\x01(\tR\x0bserviceNa\
    me\"\xaa\x02\n\"GetAttachCommandsByServiceResponse\x12'\n\x06active\x18\
    \x01\x20\x03(\x0b2\x0f.protos.CommandR\x06active\x12'\n\x06paused\x18\
    \x02\x20\x03(\x0b2\x0f.protos.CommandR\x06paused\x12^\n\x0cwasm_modules\
    \x18\x03\x20\x03(\x0b2;.protos.GetAttachCommandsByServiceResponse.WasmMo\
    dulesEntryR\x0bwasmModules\x1aR\n\x10WasmModulesEntry\x12\x10\n\x03key\
    \x18\x01\x20\x01(\tR\x03key\x12(\n\x05value\x18\x02\x20\x01(\x0b2\x12.pr\
    otos.WasmModuleR\x05value:\x028\x01\"N\n\nWasmModule\x12\x0e\n\x02id\x18\
    \x01\x20\x01(\tR\x02id\x12\x14\n\x05bytes\x18\x02\x20\x01(\x0cR\x05bytes\
    \x12\x1a\n\x08function\x18\x03\x20\x01(\tR\x08function\"i\n\x11SendSchem\
    aRequest\x12,\n\x08audience\x18\x01\x20\x01(\x0b2\x10.protos.AudienceR\
    \x08audience\x12&\n\x06schema\x18\x02\x20\x01(\x0b2\x0e.protos.SchemaR\
    ...
    ndsByServiceRequest\x1a*.protos.GetAttachCommandsByServiceResponse\x12<\
    \n\x08SendTail\x12\x14.protos.TailResponse\x1a\x18.protos.StandardRespon\
    se(\x01\x12A\n\nSendSchema\x12\x19.protos.SendSchemaRequest\x1a\x18.prot\
    os.StandardResponseB<Z:github.com/streamdal/streamdal/libs/protos/build/\
    ...
    \xbc\x02\n\x04\x06\0\x02\0\x12\x03\x10\x02@\x1a\xae\x02\x20Initial\x20me\
    ...
    \x06\0\x02\0\x03\x12\x03\x100>\n\xb0\x01\n\x04\x06\0\x02\x01\x12\x03\x15\
    ...
    \0\x02\x01\x01\x12\x03\x15\x06\x11\n\x0c\n\x05\x06\0\x02\x01\x02\x12\x03\
    ...
    \x08\x12\x03G\x17(\n\r\n\x06\x04\x02\x02\x01\x08\x03\x12\x03G\x18'\n\x0b\
    ...
    \x03\x12\x03I\"#\n\x0b\n\x04\x04\x02\x02\x04\x12\x03J\x02\x15\n\x0c\n\
    \x05\x04\x02\x02\x04\x05\x12\x03J\x02\x08\n\x0c\n\x05\x04\x02\x02\x04\
    \x01\x12\x03J\t\x10\n\x0c\n\x05\x04\x02\x02\x04\x03\x12\x03J\x13\x14\n\n\
    ...
    \x04\x03\x02\0\x01\x12\x03N\x19\x20\n\x0c\n\x05\x04\x03\x02\0\x03\x12\
    \x03N#$\n\n\n\x02\x04\x04\x12\x04Q\0f\x01\n\n\n\x03\x04\x04\x01\x12\x03Q\
    \x08\x17\nC\n\x04\x04\x04\x02\0\x12\x03S\x02\x1a\x1a6\x20REQUIRED\x20--\
    \x20Name\x20of\x20the\x20service\x20that\x20is\x20registering.\n\n\x0c\n\
    ...
    d\x20be\x20generated\x20every\x20time\x20the\x20SDK\x20is\x20instantiate\
    d\x20(oe.\x20every\n\x20time\x20a\x20NEW\x20registration\x20is\x20perfor\
    med).\n\n\x0c\n\x05\x04\x04\x02\x01\x05\x12\x03Y\x02\x08\n\x0c\n\x05\x04\
    \x04\x02\x01\x01\x12\x03Y\t\x13\n\x0c\n\x05\x04\x04\x02\x01\x03\x12\x03Y\
    \x16\x17\nQ\n\x04\x04\x04\x02\x02\x12\x03\\\x02$\x1aD\x20REQUIRED\x20--\
    ...
    \x03\x12\x03\\\"#\n\x87\x01\n\x04\x04\x04\x02\x03\x12\x03`\x02)\x1az\x20\
    OPTIONAL\x20--\x20if\x20these\x20are\x20defined,\x20these\x20will\x20sho\
    w\x20up\x20in\x20the\x20UI\x20even\x20if\n\x20there\x20is\x20no\x20activ\
    e\x20.Process()\x20call\x20from\x20the\x20SDK.\n\n\x0c\n\x05\x04\x04\x02\
    \x03\x04\x12\x03`\x02\n\n\x0c\n\x05\x04\x04\x02\x03\x06\x12\x03`\x0b\x1a\
    \n\x0c\n\x05\x04\x04\x02\x03\x01\x12\x03`\x1b$\n\x0c\n\x05\x04\x04\x02\
    \x03\x03\x12\x03`'(\n\xd9\x01\n\x04\x04\x04\x02\x04\x12\x03e\x02\x13\x1a\
    ...
    \x04\x05\x12\x03e\x02\x06\n\x0c\n\x05\x04\x04\x02\x04\x01\x12\x03e\x07\
    \x0e\n\x0c\n\x05\x04\x04\x02\x04\x03\x12\x03e\x11\x12\nT\n\x02\x04\x05\
    \x12\x04i\0l\x01\x1aH\x20Same\x20as\x20RegisterRequest\x20-\x20used\x20f\
    or\x20broadcasting\x20a\x20deregistration\x20event\n\n\n\n\x03\x04\x05\
    \x01\x12\x03i\x08\x19\n\x0b\n\x04\x04\x05\x02\0\x12\x03j\x02\x1a\n\x0c\n\
    ...
    \x05\x04\x05\x02\x01\x03\x12\x03k\x16\x17\n\n\n\x02\x04\x06\x12\x04n\0p\
    \x01\n\n\n\x03\x04\x06\x01\x12\x03n\x08)\n\x0b\n\x04\x04\x06\x02\0\x12\
    \x03o\x02\x1a\n\x0c\n\x05\x04\x06\x02\0\x05\x12\x03o\x02\x08\n\x0c\n\x05\
    \x04\x06\x02\0\x01\x12\x03o\t\x15\n\x0c\n\x05\x04\x06\x02\0\x03\x12\x03o\
    \x18\x19\n\n\n\x02\x04\x07\x12\x04r\0|\x01\n\n\n\x03\x04\x07\x01\x12\x03\
    r\x08*\n6\n\x04\x04\x07\x02\0\x12\x03t\x02%\x1a)\x20AttachCommands\x20fo\
    r\x20all\x20active\x20pipelines\n\n\x0c\n\x05\x04\x07\x02\0\x04\x12\x03t\
    \x02\n\n\x0c\n\x05\x04\x07\x02\0\x06\x12\x03t\x0b\x19\n\x0c\n\x05\x04\
    \x07\x02\0\x01\x12\x03t\x1a\x20\n\x0c\n\x05\x04\x07\x02\0\x03\x12\x03t#$\
    \nq\n\x04\x04\x07\x02\x01\x12\x03x\x02%\x1ad\x20AttachCommands,\x20but\
    \x20ones\x20which\x20are\x20paused\n\x20The\x20SDK\x20still\x20needs\x20\
    to\x20have\x20these\x20to\x20support\x20un-pausing\n\n\x0c\n\x05\x04\x07\
    \x02\x01\x04\x12\x03x\x02\n\n\x0c\n\x05\x04\x07\x02\x01\x06\x12\x03x\x0b\
    \x19\n\x0c\n\x05\x04\x07\x02\x01\x01\x12\x03x\x1a\x20\n\x0c\n\x05\x04\
    \x07\x02\x01\x03\x12\x03x#$\n\x1b\n\x04\x04\x07\x02\x02\x12\x03{\x02*\
