...
pub struct PipelineStepConditions {
    ...
    pub abort: ::std::option::Option<::protobuf::EnumOrUnknown<AbortCondition>>,
...
impl ::protobuf::Message for PipelineStepConditions {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.abort = ::std::option::Option::Some(is.read_enum_or_unknown()?);
                },
                16 => {
    ...
    fn clear(&mut self) {
        self.abort = ::std::option::Option::None;
        self.notify = ::std::option::Option::None;
        self.special_fields.clear();
    }

    fn default_instance() -> &'static PipelineStepConditions {
        static instance: PipelineStepConditions = PipelineStepConditions {
            abort: ::std::option::Option::None,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ationConfigs\"}\n\x16PipelineStepConditions\x121\n\x05abort\x18\x01\x20\
    \x01(\x0e2\x16.protos.AbortConditionH\0R\x05abort\x88\x01\x01\x12\x1b\n\
    \x06notify\x18\x02\x20\x01(\x08H\x01R\x06notify\x88\x01\x01B\x08\n\x06_a\
    bortB\t\n\x07_notify\"\xf6\x07\n\x0cPipelineStep\x12\x12\n\x04name\x18\
    \x01\x20\x01(\tR\x04name\x127\n\x07on_true\x18\x02\x20\x01(\x0b2\x1e.pro\
    tos.PipelineStepConditionsR\x06onTrue\x129\n\x08on_false\x18\x03\x20\x01\
    (\x0b2\x1e.protos.PipelineStepConditionsR\x07onFalse\x12\x18\n\x07dynami\
    c\x18\x04\x20\x01(\x08R\x07dynamic\x129\n\x08on_error\x18\x05\x20\x01(\
    \x0b2\x1e.protos.PipelineStepConditionsR\x07onError\x12<\n\tdetective\
    \x18\xe8\x07\x20\x01(\x0b2\x1b.protos.steps.DetectiveStepH\0R\tdetective\
    \x12<\n\ttransform\x18\xe9\x07\x20\x01(\x0b2\x1b.protos.steps.TransformS\
    tepH\0R\ttransform\x123\n\x06encode\x18\xea\x07\x20\x01(\x0b2\x18.protos\
    .steps.EncodeStepH\0R\x06encode\x123\n\x06decode\x18\xeb\x07\x20\x01(\
    ...
    ITION_ABORT_CURRENT\x10\x01\x12\x1d\n\x19ABORT_CONDITION_ABORT_ALL\x10\
    \x02B<Z:github.com/streamdal/streamdal/libs/protos/build/go/protosJ\xbe\
    ...
    \x0b\x12\x03\x10\0Q\n\xc8\x01\n\x02\x04\0\x12\x04\x15\0#\x01\x1a\xbb\x01\
    ...
    \x03\x12\x03\x18\x0e\x0f\n-\n\x04\x04\0\x02\x01\x12\x03\x1b\x02\x12\x1a\
    ...
    \0\x02\x02\x12\x03\x1e\x02\"\x1a\x1e\x20One\x20or\x20more\x20steps\x20to\
    \x20execute\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\x03\x1e\x02\n\n\x0c\n\
    \x05\x04\0\x02\x02\x06\x12\x03\x1e\x0b\x17\n\x0c\n\x05\x04\0\x02\x02\x01\
    \x12\x03\x1e\x18\x1d\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03\x1e\x20!\n\
    \x98\x01\n\x04\x04\0\x02\x03\x12\x03\"\x02?\x1aT\x20Notification\x20conf\
    igs\x20for\x20this\x20pipeline.\x20Only\x20filled\x20out\n\x20in\x20exte\
    rnal\x20API\x20responses\n\"5\x20protolint:disable:this\x20FIELD_NAMES_L\
    OWER_SNAKE_CASE\n\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x03\"\x02\n\n\x0c\n\
    \x05\x04\0\x02\x03\x06\x12\x03\"\x0b$\n\x0c\n\x05\x04\0\x02\x03\x01\x12\
    \x03\"%:\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03\"=>\nA\n\x02\x05\0\x12\
    \x04&\0*\x01\x1a5\x20Defines\x20the\x20ways\x20in\x20which\x20a\x20pipel\
    ...
    \x05\0\x02\x02\x02\x12\x03)\x1e\x1f\n\xb2\x01\n\x02\x04\x01\x12\x04/\08\
    \x01\x1a\xa5\x01\x20Conditions\x20define\x20how\x20the\x20SDK\x20should\
    ...
    \x12\x03/\x08\x1e\n)\n\x04\x04\x01\x02\0\x12\x031\x02$\x1a\x1c\x20Should\
    \x20we\x20abort\x20execution?\n\n\x0c\n\x05\x04\x01\x02\0\x04\x12\x031\
    \x02\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x031\x0b\x19\n\x0c\n\x05\x04\
    \x01\x02\0\x01\x12\x031\x1a\x1f\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x031\"\
    #\n0\n\x04\x04\x01\x02\x01\x12\x034\x02\x1b\x1a#\x20Should\x20we\x20trig\
    ger\x20a\x20notification?\n\n\x0c\n\x05\x04\x01\x02\x01\x04\x12\x034\x02\
    \n\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x034\x0b\x0f\n\x0c\n\x05\x04\x01\
    \x02\x01\x01\x12\x034\x10\x16\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x034\
    \x19\x1a\n=\n\x02\x04\x02\x12\x04;\0`\x01\x1a1\x20A\x20pipeline\x20step\
    ...
    \x03@\x02%\x1aN\x20SDKs\x20should\x20read\x20this\x20when\x20Wasm\x20ret\
    urns\x20'true'\x20to\x20determine\x20what\x20to\x20do\x20next.\n\n\x0c\n\
    \x05\x04\x02\x02\x01\x06\x12\x03@\x02\x18\n\x0c\n\x05\x04\x02\x02\x01\
    \x01\x12\x03@\x19\x20\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03@#$\n\\\n\
    \x04\x04\x02\x02\x02\x12\x03C\x02&\x1aO\x20SDKs\x20should\x20read\x20thi\
    s\x20when\x20Wasm\x20returns\x20'false'\x20to\x20determine\x20what\x20to\
    \x20do\x20next.\n\n\x0c\n\x05\x04\x02\x02\x02\x06\x12\x03C\x02\x18\n\x0c\
    \n\x05\x04\x02\x02\x02\x01\x12\x03C\x19!\n\x0c\n\x05\x04\x02\x02\x02\x03\
    \x12\x03C$%\n^\n\x04\x04\x02\x02\x03\x12\x03F\x02\x13\x1aQ\x20Indicates\
    ...
    \x0c\n\x05\x04\x02\x02\x03\x03\x12\x03F\x11\x12\n\\\n\x04\x04\x02\x02\
    \x04\x12\x03I\x02&\x1aO\x20SDKs\x20should\x20read\x20this\x20when\x20Was\
    m\x20returns\x20'error'\x20to\x20determine\x20what\x20to\x20do\x20next.\
    \n\n\x0c\n\x05\x04\x02\x02\x04\x06\x12\x03I\x02\x18\n\x0c\n\x05\x04\x02\
    \x02\x04\x01\x12\x03I\x19!\n\x0c\n\x05\x04\x02\x02\x04\x03\x12\x03I$%\n\
    \x0c\n\x04\x04\x02\x08\0\x12\x04K\x02V\x03\n\x0c\n\x05\x04\x02\x08\0\x01\
    \x12\x03K\x08\x0c\n\x0b\n\x04\x04\x02\x02\x05\x12\x03L\x04)\n\x0c\n\x05\
    \x04\x02\x02\x05\x06\x12\x03L\x04\x17\n\x0c\n\x05\x04\x02\x02\x05\x01\
    \x12\x03L\x18!\n\x0c\n\x05\x04\x02\x02\x05\x03\x12\x03L$(\n\x0b\n\x04\
    \x04\x02\x02\x06\x12\x03M\x04)\n\x0c\n\x05\x04\x02\x02\x06\x06\x12\x03M\
    \x04\x17\n\x0c\n\x05\x04\x02\x02\x06\x01\x12\x03M\x18!\n\x0c\n\x05\x04\
    \x02\x02\x06\x03\x12\x03M$(\n\x0b\n\x04\x04\x02\x02\x07\x12\x03N\x04#\n\
    \x0c\n\x05\x04\x02\x02\x07\x06\x12\x03N\x04\x14\n\x0c\n\x05\x04\x02\x02\
