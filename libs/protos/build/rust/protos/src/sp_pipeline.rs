...
pub struct PipelineStepConditions {
    ...
    // @@protoc_insertion_point(field:protos.PipelineStepConditions._notification_configs)
    pub _notification_configs: ::std::vec::Vec<super::sp_notify::NotificationConfig>,
    // special fields
...
impl PipelineStepConditions {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "_notification_configs",
            |m: &PipelineStepConditions| { &m._notification_configs },
            |m: &mut PipelineStepConditions| { &mut m._notification_configs },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ationConfigsB\x02\x18\x01\"\xb9\x02\n\x16PipelineStepConditions\x12,\n\
    ...
    tryR\x08metadata\x12N\n\x15_notification_configs\x18\x04\x20\x03(\x0b2\
    \x1a.protos.NotificationConfigR\x13NotificationConfigs\x1a;\n\rMetadataE\
    ntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\
    \x02\x20\x01(\tR\x05value:\x028\x01\"\x80\x08\n\x0cPipelineStep\x12\x12\
    \n\x04name\x18\x01\x20\x01(\tR\x04name\x12=\n\non_success\x18\x02\x20\
    \x01(\x0b2\x1e.protos.PipelineStepConditionsR\tonSuccess\x12=\n\non_fail\
    ure\x18\x03\x20\x01(\x0b2\x1e.protos.PipelineStepConditionsR\tonFailure\
    \x12\x18\n\x07dynamic\x18\x04\x20\x01(\x08R\x07dynamic\x129\n\x08on_erro\
    r\x18\x05\x20\x01(\x0b2\x1e.protos.PipelineStepConditionsR\x07onError\
    ...
    \x12\x03\x1e\x20!\n\x98\x01\n\x04\x04\0\x02\x03\x12\x03#\x02Q\"5\x20prot\
    olint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n2T\x20Notification\
    \x20configs\x20for\x20this\x20pipeline.\x20Only\x20filled\x20out\n\x20in\
    \x20external\x20API\x20responses\n\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x03\
    ...
    \x12\x040\0=\x01\x1a\xf5\x01\x20Conditions\x20define\x20how\x20the\x20SD\
    K\x20should\x20handle\x20a\x20Wasm\x20response\x20in\x20a\x20step.\n\x20\
    Should\x20it\x20continue\x20executing\x20the\x20pipeline,\x20should\x20i\
    t\x20abort,\x20should\x20it\x20notify\n\x20the\x20server?\x20Each\x20ste\
    p\x20can\x20have\x20exactly\x20one\x20of\x20these\x20for\x20on_success,\
    \x20on_failure\n\x20and\x20on_error.\n\n\n\n\x03\x04\x01\x01\x12\x030\
    \x08\x1e\n)\n\x04\x04\x01\x02\0\x12\x032\x02\x1b\x1a\x1c\x20Should\x20we\
    \x20abort\x20execution?\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x032\x02\x10\
    \n\x0c\n\x05\x04\x01\x02\0\x01\x12\x032\x11\x16\n\x0c\n\x05\x04\x01\x02\
    \0\x03\x12\x032\x19\x1a\nq\n\x04\x04\x01\x02\x01\x12\x036\x02$\x1ad\x20S\
    hould\x20we\x20trigger\x20a\x20notification?\n\x20This\x20is\x20deprecat\
    ed\x20and\x20you\x20should\x20use\x20notify_data\x20field\x20instead\n\n\
    \x0c\n\x05\x04\x01\x02\x01\x05\x12\x036\x02\x06\n\x0c\n\x05\x04\x01\x02\
    \x01\x01\x12\x036\x07\r\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x036\x10\x11\
    \n\x0c\n\x05\x04\x01\x02\x01\x08\x12\x036\x12#\n\r\n\x06\x04\x01\x02\x01\
    \x08\x03\x12\x036\x13\"\nW\n\x04\x04\x01\x02\x02\x12\x039\x02#\x1aJ\x20S\
    hould\x20we\x20include\x20additional\x20metadata\x20that\x20SDK\x20shoul\
    d\x20pass\x20back\x20to\x20user?\n\n\x0c\n\x05\x04\x01\x02\x02\x06\x12\
    \x039\x02\x15\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x039\x16\x1e\n\x0c\n\
    \x05\x04\x01\x02\x02\x03\x12\x039!\"\nl\n\x04\x04\x01\x02\x03\x12\x03<\
    \x02?\x1a(\x20Notification\x20configs\x20for\x20this\x20pipeline\n\"5\
    ...
    \x01\x02\x03\x03\x12\x03<=>\n=\n\x02\x04\x02\x12\x04@\0e\x01\x1a1\x20A\
    \x20pipeline\x20step\x20is\x20a\x20single\x20step\x20in\x20a\x20pipeline\
    .\n\n\n\n\x03\x04\x02\x01\x12\x03@\x08\x14\n)\n\x04\x04\x02\x02\0\x12\
    \x03B\x02\x12\x1a\x1c\x20Friendly\x20name\x20for\x20the\x20step\n\n\x0c\
    \n\x05\x04\x02\x02\0\x05\x12\x03B\x02\x08\n\x0c\n\x05\x04\x02\x02\0\x01\
    \x12\x03B\t\r\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03B\x10\x11\n[\n\x04\
    \x04\x02\x02\x01\x12\x03E\x02(\x1aN\x20SDKs\x20should\x20read\x20this\
    \x20when\x20WASM\x20returns\x20success\x20to\x20determine\x20what\x20to\
    \x20do\x20next\n\n\x0c\n\x05\x04\x02\x02\x01\x06\x12\x03E\x02\x18\n\x0c\
    \n\x05\x04\x02\x02\x01\x01\x12\x03E\x19#\n\x0c\n\x05\x04\x02\x02\x01\x03\
    \x12\x03E&'\n[\n\x04\x04\x02\x02\x02\x12\x03H\x02(\x1aN\x20SDKs\x20shoul\
    ...
    H\x02\x18\n\x0c\n\x05\x04\x02\x02\x02\x01\x12\x03H\x19#\n\x0c\n\x05\x04\
    \x02\x02\x02\x03\x12\x03H&'\n^\n\x04\x04\x02\x02\x03\x12\x03K\x02\x13\
    \x1aQ\x20Indicates\x20whether\x20to\x20use\x20the\x20results\x20from\x20\
    a\x20previous\x20step\x20as\x20input\x20to\x20this\x20step\n\n\x0c\n\x05\
    \x04\x02\x02\x03\x05\x12\x03K\x02\x06\n\x0c\n\x05\x04\x02\x02\x03\x01\
    \x04\x10\n\x0c\n\x05\x04\x02\x02\x0b\x01\x12\x03W\x11\x13\n\x0c\n\x05\
    \x04\x02\x02\x0b\x03\x12\x03W\x16\x1a\n\x0b\n\x04\x04\x02\x02\x0c\x12\
    \x03X\x04.\n\x0c\n\x05\x04\x02\x02\x0c\x06\x12\x03X\x04\x19\n\x0c\n\x05\
    \x04\x02\x02\x0c\x01\x12\x03X\x1a&\n\x0c\n\x05\x04\x02\x02\x0c\x03\x12\
    \x03X)-\n\x0b\n\x04\x04\x02\x02\r\x12\x03Y\x04*\n\x0c\n\x05\x04\x02\x02\
    \r\x06\x12\x03Y\x04\x17\n\x0c\n\x05\x04\x02\x02\r\x01\x12\x03Y\x18\"\n\
    \x0c\n\x05\x04\x02\x02\r\x03\x12\x03Y%)\n\x0b\n\x04\x04\x02\x02\x0e\x12\
    \x03Z\x048\n\x0c\n\x05\x04\x02\x02\x0e\x06\x12\x03Z\x04\x1e\n\x0c\n\x05\
    \x04\x02\x02\x0e\x01\x12\x03Z\x1f0\n\x0c\n\x05\x04\x02\x02\x0e\x03\x12\
    \x03Z37\n}\n\x04\x04\x02\x02\x0f\x12\x03^\x02#\x1a9\x20ID\x20is\x20a\x20\
    uuid(sha256(_wasm_bytes))\x20that\x20is\x20set\x20by\x20server\n\"5\x20p\
    rotolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\
    \x02\x02\x0f\x04\x12\x03^\x02\n\n\x0c\n\x05\x04\x02\x02\x0f\x05\x12\x03^\
    \x0b\x11\n\x0c\n\x05\x04\x02\x02\x0f\x01\x12\x03^\x12\x1a\n\x0c\n\x05\
    \x04\x02\x02\x0f\x03\x12\x03^\x1d\"\ng\n\x04\x04\x02\x02\x10\x12\x03a\
    \x02%\x1a#\x20WASM\x20module\x20bytes\x20(set\x20by\x20server)\n\"5\x20p\
    rotolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\
    \x02\x02\x10\x04\x12\x03a\x02\n\n\x0c\n\x05\x04\x02\x02\x10\x05\x12\x03a\
    \x0b\x10\n\x0c\n\x05\x04\x02\x02\x10\x01\x12\x03a\x11\x1c\n\x0c\n\x05\
    \x04\x02\x02\x10\x03\x12\x03a\x1f$\ns\n\x04\x04\x02\x02\x11\x12\x03d\x02\
    )\x1a/\x20WASM\x20function\x20name\x20to\x20execute\x20(set\x20by\x20ser\
    ver)\n\"5\x20protolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\
    \x0c\n\x05\x04\x02\x02\x11\x04\x12\x03d\x02\n\n\x0c\n\x05\x04\x02\x02\
    \x11\x05\x12\x03d\x0b\x11\n\x0c\n\x05\x04\x02\x02\x11\x01\x12\x03d\x12\
    \x20\n\x0c\n\x05\x04\x02\x02\x11\x03\x12\x03d#(b\x06proto3\
";
