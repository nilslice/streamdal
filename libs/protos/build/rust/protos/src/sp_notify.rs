...
pub struct NotificationConfig {
    ...
    // @@protoc_insertion_point(field:protos.NotificationConfig.payload_info)
    pub payload_info: ::protobuf::MessageField<NotificationPayloadInfo>,
...
impl NotificationConfig {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, NotificationPayloadInfo>(
            "payload_info",
            |m: &NotificationConfig| { &m.payload_info },
            |m: &mut NotificationConfig| { &mut m.payload_info },
        ));
...
impl ::protobuf::Message for NotificationConfig {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.payload_info)?;
                },
                8002 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.payload_info.as_ref() {
    ...
    fn default_instance() -> &'static NotificationConfig {
        static instance: NotificationConfig = NotificationConfig {
            ...
            payload_info: ::protobuf::MessageField::none(),
...
// @@protoc_insertion_point(message:protos.NotificationPayloadInfo)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct NotificationPayloadInfo {
    // message fields
    // @@protoc_insertion_point(field:protos.NotificationPayloadInfo.type)
    pub type_: ::protobuf::EnumOrUnknown<NotificationPayloadInfoType>,
    ///  JSON paths to be included in the notification
    ///  If type is PAYLOAD, this is ignored
    // @@protoc_insertion_point(field:protos.NotificationPayloadInfo.paths)
    pub paths: ::std::vec::Vec<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:protos.NotificationPayloadInfo.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a NotificationPayloadInfo {
    fn default() -> &'a NotificationPayloadInfo {
        <NotificationPayloadInfo as ::protobuf::Message>::default_instance()
    }
}

impl NotificationPayloadInfo {
    pub fn new() -> NotificationPayloadInfo {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "type",
            |m: &NotificationPayloadInfo| { &m.type_ },
            |m: &mut NotificationPayloadInfo| { &mut m.type_ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "paths",
            |m: &NotificationPayloadInfo| { &m.paths },
            |m: &mut NotificationPayloadInfo| { &mut m.paths },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<NotificationPayloadInfo>(
...
impl ::protobuf::Message for NotificationPayloadInfo {
    const NAME: &'static str = "NotificationPayloadInfo";
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.type_ != ::protobuf::EnumOrUnknown::new(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET) {
            my_size += ::protobuf::rt::int32_size(1, self.type_.value());
        }
    ...
    fn new() -> NotificationPayloadInfo {
        NotificationPayloadInfo::new()
    }

    fn clear(&mut self) {
        self.type_ = ::protobuf::EnumOrUnknown::new(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET);
        self.paths.clear();
        self.special_fields.clear();
    }

    fn default_instance() -> &'static NotificationPayloadInfo {
        static instance: NotificationPayloadInfo = NotificationPayloadInfo {
            type_: ::protobuf::EnumOrUnknown::from_i32(0),
...
impl ::protobuf::MessageFull for NotificationPayloadInfo {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("NotificationPayloadInfo").unwrap()).clone()
    }
}

impl ::std::fmt::Display for NotificationPayloadInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for NotificationPayloadInfo {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
#[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
// @@protoc_insertion_point(enum:protos.NotificationPayloadInfoType)
pub enum NotificationPayloadInfoType {
    // @@protoc_insertion_point(enum_value:protos.NotificationPayloadInfoType.NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET)
    NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET = 0,
    // @@protoc_insertion_point(enum_value:protos.NotificationPayloadInfoType.NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA)
    NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA = 1,
    // @@protoc_insertion_point(enum_value:protos.NotificationPayloadInfoType.NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD)
    NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD = 2,
    // @@protoc_insertion_point(enum_value:protos.NotificationPayloadInfoType.NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS)
    NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS = 3,
}

impl ::protobuf::Enum for NotificationPayloadInfoType {
    const NAME: &'static str = "NotificationPayloadInfoType";

    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<NotificationPayloadInfoType> {
        match value {
            0 => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET),
            1 => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA),
            2 => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD),
            3 => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS),
            _ => ::std::option::Option::None
        }
    }

    fn from_str(str: &str) -> ::std::option::Option<NotificationPayloadInfoType> {
        match str {
            "NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET" => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET),
            "NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA" => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA),
            "NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD" => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD),
            "NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS" => ::std::option::Option::Some(NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [NotificationPayloadInfoType] = &[
        NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET,
        NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA,
        NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD,
        NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS,
    ];
}

impl ::protobuf::EnumFull for NotificationPayloadInfoType {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("NotificationPayloadInfoType").unwrap()).clone()
    }
...
impl ::std::default::Default for NotificationPayloadInfoType {
    fn default() -> Self {
        NotificationPayloadInfoType::NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET
    }
}

impl NotificationPayloadInfoType {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<NotificationPayloadInfoType>("NotificationPayloadInfoType")
    }
}

static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fsp_notify.proto\x12\x06protos\"\xe8\x02\n\x12NotificationConfig\
    \x12\x13\n\x02id\x18\x01\x20\x01(\tH\x01R\x02id\x88\x01\x01\x12\x12\n\
    \x04name\x18\x02\x20\x01(\tR\x04name\x12,\n\x04type\x18\x03\x20\x01(\x0e\
    2\x18.protos.NotificationTypeR\x04type\x12B\n\x0cpayload_info\x18\x04\
    \x20\x01(\x0b2\x1f.protos.NotificationPayloadInfoR\x0bpayloadInfo\x122\n\
    \x05slack\x18\xe8\x07\x20\x01(\x0b2\x19.protos.NotificationSlackH\0R\x05\
    slack\x122\n\x05email\x18\xe9\x07\x20\x01(\x0b2\x19.protos.NotificationE\
    mailH\0R\x05email\x12>\n\tpagerduty\x18\xea\x07\x20\x01(\x0b2\x1d.protos\
    .NotificationPagerDutyH\0R\tpagerdutyB\x08\n\x06configB\x05\n\x03_id\"J\
    \n\x11NotificationSlack\x12\x1b\n\tbot_token\x18\x01\x20\x01(\tR\x08botT\
    oken\x12\x18\n\x07channel\x18\x02\x20\x01(\tR\x07channel\"\xb2\x02\n\x11\
    NotificationEmail\x122\n\x04type\x18\x01\x20\x01(\x0e2\x1e.protos.Notifi\
    cationEmail.TypeR\x04type\x12\x1e\n\nrecipients\x18\x02\x20\x03(\tR\nrec\
    ...
    \x10\x01\x12\x10\n\x0cURGENCY_HIGH\x10\x02\"h\n\x17NotificationPayloadIn\
    fo\x127\n\x04type\x18\x01\x20\x01(\x0e2#.protos.NotificationPayloadInfoT\
    ypeR\x04type\x12\x14\n\x05paths\x18\x02\x20\x03(\tR\x05paths*\x8a\x01\n\
    ...
    IL\x10\x02\x12\x1f\n\x1bNOTIFICATION_TYPE_PAGERDUTY\x10\x03*\xc9\x01\n\
    \x1bNotificationPayloadInfoType\x12(\n$NOTIFICATION_PAYLOAD_INFO_TYPE_UN\
    SET\x10\0\x12*\n&NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA\x10\x01\x12*\n&N\
    OTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD\x10\x02\x12(\n$NOTIFICATION_PAYLOA\
    D_INFO_TYPE_PATHS\x10\x03B<Z:github.com/streamdal/streamdal/libs/protos/\
    build/go/protosJ\xc0\x15\n\x06\x12\x04\0\0c\x01\n\x08\n\x01\x0c\x12\x03\
    ...
    \x04\0\x02\x03\x06\x12\x03\x14\x02\x19\n\x0c\n\x05\x04\0\x02\x03\x01\x12\
    \x03\x14\x1a&\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03\x14)*\n\x0c\n\x04\
    \x04\0\x08\0\x12\x04\x16\x02\x1a\x03\n\x0c\n\x05\x04\0\x08\0\x01\x12\x03\
    \x16\x08\x0e\n\x0b\n\x04\x04\0\x02\x04\x12\x03\x17\x04#\n\x0c\n\x05\x04\
    \0\x02\x04\x06\x12\x03\x17\x04\x15\n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03\
    \x17\x16\x1b\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03\x17\x1e\"\n\x0b\n\x04\
    \x04\0\x02\x05\x12\x03\x18\x04#\n\x0c\n\x05\x04\0\x02\x05\x06\x12\x03\
    \x18\x04\x15\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03\x18\x16\x1b\n\x0c\n\
    \x05\x04\0\x02\x05\x03\x12\x03\x18\x1e\"\n\x0b\n\x04\x04\0\x02\x06\x12\
    \x03\x19\x04+\n\x0c\n\x05\x04\0\x02\x06\x06\x12\x03\x19\x04\x19\n\x0c\n\
    \x05\x04\0\x02\x06\x01\x12\x03\x19\x1a#\n\x0c\n\x05\x04\0\x02\x06\x03\
    \x12\x03\x19&*\n\n\n\x02\x04\x01\x12\x04\x1d\0\x20\x01\n\n\n\x03\x04\x01\
    \x01\x12\x03\x1d\x08\x19\n\x0b\n\x04\x04\x01\x02\0\x12\x03\x1e\x02\x17\n\
    \x0c\n\x05\x04\x01\x02\0\x05\x12\x03\x1e\x02\x08\n\x0c\n\x05\x04\x01\x02\
    \0\x01\x12\x03\x1e\t\x12\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\x1e\x15\
    \x16\n\x0b\n\x04\x04\x01\x02\x01\x12\x03\x1f\x02\x15\n\x0c\n\x05\x04\x01\
    \x02\x01\x05\x12\x03\x1f\x02\x08\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03\
    \x1f\t\x10\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03\x1f\x13\x14\n\n\n\x02\
    \x04\x02\x12\x04\"\03\x01\n\n\n\x03\x04\x02\x01\x12\x03\"\x08\x19\n\x0c\
    \n\x04\x04\x02\x04\0\x12\x04#\x02'\x03\n\x0c\n\x05\x04\x02\x04\0\x01\x12\
    \x03#\x07\x0b\n\r\n\x06\x04\x02\x04\0\x02\0\x12\x03$\x04\x13\n\x0e\n\x07\
    \x04\x02\x04\0\x02\0\x01\x12\x03$\x04\x0e\n\x0e\n\x07\x04\x02\x04\0\x02\
    \0\x02\x12\x03$\x11\x12\n\r\n\x06\x04\x02\x04\0\x02\x01\x12\x03%\x04\x12\
n\x0c\n\x05\x04\x05\x02\0\x03\x12\x03K\
    \x11\x12\n9\n\x04\x04\x05\x02\x01\x12\x03N\x02\x13\x1a,\x20Must\x20be\
    \x20a\x20valid\x20email\x20for\x20a\x20PagerDuty\x20user\n\n\x0c\n\x05\
    \x04\x05\x02\x01\x05\x12\x03N\x02\x08\n\x0c\n\x05\x04\x05\x02\x01\x01\
    \x12\x03N\t\x0e\n\x0c\n\x05\x04\x05\x02\x01\x03\x12\x03N\x11\x12\n0\n\
    \x04\x04\x05\x02\x02\x12\x03Q\x02\x18\x1a#\x20Must\x20be\x20a\x20valid\
    \x20PagerDuty\x20service\n\n\x0c\n\x05\x04\x05\x02\x02\x05\x12\x03Q\x02\
    \x08\n\x0c\n\x05\x04\x05\x02\x02\x01\x12\x03Q\t\x13\n\x0c\n\x05\x04\x05\
    \x02\x02\x03\x12\x03Q\x16\x17\n\x0b\n\x04\x04\x05\x02\x03\x12\x03S\x02\
    \x16\n\x0c\n\x05\x04\x05\x02\x03\x06\x12\x03S\x02\t\n\x0c\n\x05\x04\x05\
    \x02\x03\x01\x12\x03S\n\x11\n\x0c\n\x05\x04\x05\x02\x03\x03\x12\x03S\x14\
    \x15\n\n\n\x02\x05\x01\x12\x04V\0[\x01\n\n\n\x03\x05\x01\x01\x12\x03V\
    \x05\x20\n\x0b\n\x04\x05\x01\x02\0\x12\x03W\x02+\n\x0c\n\x05\x05\x01\x02\
    \0\x01\x12\x03W\x02&\n\x0c\n\x05\x05\x01\x02\0\x02\x12\x03W)*\n\x0b\n\
    \x04\x05\x01\x02\x01\x12\x03X\x02-\n\x0c\n\x05\x05\x01\x02\x01\x01\x12\
    \x03X\x02(\n\x0c\n\x05\x05\x01\x02\x01\x02\x12\x03X+,\n\x0b\n\x04\x05\
    \x01\x02\x02\x12\x03Y\x02-\n\x0c\n\x05\x05\x01\x02\x02\x01\x12\x03Y\x02(\
    \n\x0c\n\x05\x05\x01\x02\x02\x02\x12\x03Y+,\n\x0b\n\x04\x05\x01\x02\x03\
    \x12\x03Z\x02+\n\x0c\n\x05\x05\x01\x02\x03\x01\x12\x03Z\x02&\n\x0c\n\x05\
    \x05\x01\x02\x03\x02\x12\x03Z)*\n\n\n\x02\x04\x06\x12\x04]\0c\x01\n\n\n\
    \x03\x04\x06\x01\x12\x03]\x08\x1f\n\x0b\n\x04\x04\x06\x02\0\x12\x03^\x02\
    '\n\x0c\n\x05\x04\x06\x02\0\x06\x12\x03^\x02\x1d\n\x0c\n\x05\x04\x06\x02\
    \0\x01\x12\x03^\x1e\"\n\x0c\n\x05\x04\x06\x02\0\x03\x12\x03^%&\na\n\x04\
    \x04\x06\x02\x01\x12\x03b\x02\x1c\x1aT\x20JSON\x20paths\x20to\x20be\x20i\
    ncluded\x20in\x20the\x20notification\n\x20If\x20type\x20is\x20PAYLOAD,\
    \x20this\x20is\x20ignored\n\n\x0c\n\x05\x04\x06\x02\x01\x04\x12\x03b\x02\
    \n\n\x0c\n\x05\x04\x06\x02\x01\x05\x12\x03b\x0b\x11\n\x0c\n\x05\x04\x06\
    \x02\x01\x01\x12\x03b\x12\x17\n\x0c\n\x05\x04\x06\x02\x01\x03\x12\x03b\
    \x1a\x1bb\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(NotificationPayloadInfo::generated_message_descriptor_data());
            let mut enums = ::std::vec::Vec::with_capacity(4);
            enums.push(NotificationType::generated_enum_descriptor_data());
            enums.push(NotificationPayloadInfoType::generated_enum_descriptor_data());
