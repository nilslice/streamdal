...
exports.PipelineStep = exports.PipelineStepNotifyData = exports.PipelineStepConditions = exports.Pipeline = exports.PipelineStepNotifyDataType = exports.AbortCondition = void 0;
 ...
 */
var PipelineStepNotifyDataType;
...
})(PipelineStepNotifyDataType || (exports.PipelineStepNotifyDataType = PipelineStepNotifyDataType = {}));
...
class PipelineStepConditions$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.PipelineStepConditions", [
            ...
            { no: 4, name: "notify_data", kind: "message", T: () => exports.PipelineStepNotifyData }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* protos.PipelineStepNotifyData notify_data */ 4:
                    message.notifyData = exports.PipelineStepNotifyData.internalBinaryRead(reader, reader.uint32(), options, message.notifyData);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.notifyData)
            exports.PipelineStepNotifyData.internalBinaryWrite(message.notifyData, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class PipelineStepNotifyData$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.PipelineStepNotifyData = new PipelineStepNotifyData$Type();
// @generated message type with reflection information, may provide speed optimized methods
