...
type NotificationPayloadInfoType int32

const (
	NotificationPayloadInfoType_NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET   NotificationPayloadInfoType = 0
	NotificationPayloadInfoType_NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA NotificationPayloadInfoType = 1
	NotificationPayloadInfoType_NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD NotificationPayloadInfoType = 2
	NotificationPayloadInfoType_NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS   NotificationPayloadInfoType = 3
)

// Enum value maps for NotificationPayloadInfoType.
var (
	NotificationPayloadInfoType_name = map[int32]string{
		0: "NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET",
		1: "NOTIFICATION_PAYLOAD_INFO_TYPE_NO_DATA",
		2: "NOTIFICATION_PAYLOAD_INFO_TYPE_PAYLOAD",
		3: "NOTIFICATION_PAYLOAD_INFO_TYPE_PATHS",
	}
	NotificationPayloadInfoType_value = map[string]int32{
...
func (x NotificationPayloadInfoType) Enum() *NotificationPayloadInfoType {
	p := new(NotificationPayloadInfoType)
	*p = x
	return p
}

func (x NotificationPayloadInfoType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NotificationPayloadInfoType) Descriptor() protoreflect.EnumDescriptor {
	return file_sp_notify_proto_enumTypes[1].Descriptor()
}

func (NotificationPayloadInfoType) Type() protoreflect.EnumType {
	return &file_sp_notify_proto_enumTypes[1]
}

func (x NotificationPayloadInfoType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use NotificationPayloadInfoType.Descriptor instead.
func (NotificationPayloadInfoType) EnumDescriptor() ([]byte, []int) {
...
func (NotificationPagerDuty_Urgency) Descriptor() protoreflect.EnumDescriptor {
	return file_sp_notify_proto_enumTypes[3].Descriptor()
}

func (NotificationPagerDuty_Urgency) Type() protoreflect.EnumType {
	return &file_sp_notify_proto_enumTypes[3]
}
...
type NotificationConfig struct {
	...
	PayloadInfo *NotificationPayloadInfo `protobuf:"bytes,4,opt,name=payload_info,json=payloadInfo,proto3" json:"payload_info,omitempty"`
...
func (x *NotificationConfig) GetPayloadInfo() *NotificationPayloadInfo {
	if x != nil {
...
type NotificationPayloadInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type NotificationPayloadInfoType `protobuf:"varint,1,opt,name=type,proto3,enum=protos.NotificationPayloadInfoType" json:"type,omitempty"`
	// JSON paths to be included in the notification
	// If type is PAYLOAD, this is ignored
	Paths []string `protobuf:"bytes,2,rep,name=paths,proto3" json:"paths,omitempty"`
}

func (x *NotificationPayloadInfo) Reset() {
	*x = NotificationPayloadInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sp_notify_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *NotificationPayloadInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotificationPayloadInfo) ProtoMessage() {}

func (x *NotificationPayloadInfo) ProtoReflect() protoreflect.Message {
	mi := &file_sp_notify_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotificationPayloadInfo.ProtoReflect.Descriptor instead.
func (*NotificationPayloadInfo) Descriptor() ([]byte, []int) {
	return file_sp_notify_proto_rawDescGZIP(), []int{6}
}

func (x *NotificationPayloadInfo) GetType() NotificationPayloadInfoType {
	if x != nil {
		return x.Type
	}
	return NotificationPayloadInfoType_NOTIFICATION_PAYLOAD_INFO_TYPE_UNSET
}

func (x *NotificationPayloadInfo) GetPaths() []string {
	if x != nil {
		return x.Paths
	}
	return nil
...
var file_sp_notify_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x22, 0xe8, 0x02, 0x0a, 0x12, 0x4e, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_sp_notify_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_sp_notify_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_sp_notify_proto_goTypes = []interface{}{
	(NotificationType)(0),              // 0: protos.NotificationType
	(NotificationPayloadInfoType)(0),   // 1: protos.NotificationPayloadInfoType
	(NotificationEmail_Type)(0),        // 2: protos.NotificationEmail.Type
	(NotificationPagerDuty_Urgency)(0), // 3: protos.NotificationPagerDuty.Urgency
	(*NotificationConfig)(nil),         // 4: protos.NotificationConfig
	(*NotificationSlack)(nil),          // 5: protos.NotificationSlack
	(*NotificationEmail)(nil),          // 6: protos.NotificationEmail
	(*NotificationEmailSMTP)(nil),      // 7: protos.NotificationEmailSMTP
	(*NotificationEmailSES)(nil),       // 8: protos.NotificationEmailSES
	(*NotificationPagerDuty)(nil),      // 9: protos.NotificationPagerDuty
	(*NotificationPayloadInfo)(nil),    // 10: protos.NotificationPayloadInfo
}
var file_sp_notify_proto_depIdxs = []int32{
	0,  // 0: protos.NotificationConfig.type:type_name -> protos.NotificationType
	10, // 1: protos.NotificationConfig.payload_info:type_name -> protos.NotificationPayloadInfo
	5,  // 2: protos.NotificationConfig.slack:type_name -> protos.NotificationSlack
	6,  // 3: protos.NotificationConfig.email:type_name -> protos.NotificationEmail
	9,  // 4: protos.NotificationConfig.pagerduty:type_name -> protos.NotificationPagerDuty
	2,  // 5: protos.NotificationEmail.type:type_name -> protos.NotificationEmail.Type
	7,  // 6: protos.NotificationEmail.smtp:type_name -> protos.NotificationEmailSMTP
	8,  // 7: protos.NotificationEmail.ses:type_name -> protos.NotificationEmailSES
	3,  // 8: protos.NotificationPagerDuty.urgency:type_name -> protos.NotificationPagerDuty.Urgency
	1,  // 9: protos.NotificationPayloadInfo.type:type_name -> protos.NotificationPayloadInfoType
...
func file_sp_notify_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sp_notify_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NotificationPayloadInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
